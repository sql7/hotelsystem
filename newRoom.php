...
<head>
    <meta charset="utf-8"/>
    <title>酒店管理系统 -添加新产品</title>
    <meta name="keywords" content="GDPC"/>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" action="../controller/publishRoom.php" method="post" enctype="multipart/form-data" onsubmit="return validate()">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="znecancelPrice">酒店可取消价格</label>

                                <div class="col-sm-9">
                                    <input type="text" id="znecancelPrice" name="znecancelPrice" placeholder="酒店可取消价格" class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="znePrice">酒店不可取消价格</label>

                                <div class="col-sm-9">
                                    <input type="text" id="znePrice" name="znePrice" placeholder="酒店不可取消价格" class="col-xs-10 col-sm-5"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="marketingTime">主图</label>
    ...
    <script type="text/javascript">
        ...
        $("#znecancelPrice").on("blur", function() {
            if ($("#znecancelPrice").val() === "") {
                ...
                $("#znecancelPriceError>div").text("温馨提示：请输入酒店可取消价格");
            } else{
        ...
        $("#znePrice").on("blur", function() {
            if ($("#znePrice").val() === "") {
                ...
                $("#znePriceError>div").text("温馨提示：请输入酒店不可取消价格");
            } else{
