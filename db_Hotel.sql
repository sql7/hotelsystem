...
CREATE TABLE `hotel` (
  ...
  `image1` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '酒店主图',
...
CREATE TABLE `room` (
  ...
  `znecancelPrice` int(10) NOT NULL DEFAULT '0' COMMENT '酒店可取消价格',
  `znePrice` int(10) NOT NULL DEFAULT '0' COMMENT '酒店不可取消价格',
